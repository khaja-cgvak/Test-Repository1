...
/*$(document).on('click', '.nav-primary a span.pull-right', function(e) { 
	...
	setTimeout(function() { $(document).trigger('updateNav'); }
, 300); }

);*/


/*$( ".nav-primary a span" ).click(function() {
