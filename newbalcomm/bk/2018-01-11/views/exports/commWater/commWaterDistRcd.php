...
<table  border="1" cellpadding="10" cellspacing="0" width="100%">
	<thead>
		<tr>
			<th align="center" colspan="7">Design Information</th>
	...
	<tbody>
		<tr>
			...
			<td align="center" width="10%"><strong>Reg.<br>Set</strong></td>
			<td align="center" width="10%"><strong>Bypass<br>set</strong></td>
		</tr>
		<?php
		...
		<tr>
			...
			<td><?php echo ((isset($gd_value['measurregset'])) ? $gd_value['measurregset'] : ''); ?></td>
			<td><?php echo ((isset($gd_value['measurbypasset'])) ? $gd_value['measurbypasset'] : ''); ?></td>
		</tr>
		<?php
		}
		?>
