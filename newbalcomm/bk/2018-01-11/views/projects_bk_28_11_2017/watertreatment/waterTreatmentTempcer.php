			...
			<form method="POST" name="adduser" action="" class="addusernew">
				...
				<div class="panel-body">
					        	...
					        	<div class="form-group clearfix">
					        		...
					        		<div class="col-sm-4"><input type="text" name="reportref" class="form-control" value="<?php echo set_value('reportref', (isset($prcdata['referenceno'])) ? $prcdata['referenceno'] : ''); ?>">
					        	...
					        	<div class="form-group clearfix">
					        		...
					        		<div class="col-sm-4"><input type="text" class="form-control" name="contractname" placeholder="" value="<?php echo set_value('contractname', (isset($prcdata['contractname'])) ? $prcdata['contractname'] : ''); ?>" /><?php echo form_error('reportref', '<div class="form-error">', '</div>'); ?></div>					        		
					        	</div>
					        	<div class="form-group clearfix">
                        ...
                        ?>	</div>
					        	...
					        	<div class="form-group clearfix">
					        		...
					        		<select name="accord1">
					        			...
					        			<option value="1" <?php if($accord1==1) { echo "selected";} ?>>B8558</option>
					        			<option value="2" <?php if($accord1==2) { echo "selected";} ?>>BS 6700</option>
					        		</select>
					        		<strong> or </strong>					        		
					        		<select name="accord2">
					        			<option value="">Please Select</option>
					        			<option value="1" <?php if($accord2==1) { echo "selected";} ?>>B8558</option>
					        			<option value="2" <?php if($accord2==2) { echo "selected";} ?>>BS 6700</option>
					        		</select>
					        		<strong>:-</strong>
					        		</div>
					        	...
					        	<div class="form-group clearfix">
					        		<div class="col-sm-12"><textarea class="form-control" name="commaircomments"><?php echo set_value('commaircomments', (isset($prcdata['comments'])) ? $prcdata['comments'] : ''); ?></textarea></div>
					        	</div>
					        	<div class="form-group clearfix">
