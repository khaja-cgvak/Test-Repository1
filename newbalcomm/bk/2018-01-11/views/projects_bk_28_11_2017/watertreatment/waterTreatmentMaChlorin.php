					        	...
					        	<div class="row form-group clearfix">
					        		<div class="row clearfix">
					        			<div class="col-sm-12">
											...
											<div class="col-sm-9"><input type="text" name="contractname" class="form-control" value="<?php echo set_value('contractname', (isset($mainChlorin['contractname'])) ? $mainChlorin['contractname'] : ''); ?>">
                       ...
                       // print_r($client_name);
                        ...
                        ?></div>
								...
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row clearfix">
											...
											<div class="col-sm-9">
											<input type="text" class="form-control" name="lebref" value="<?php echo set_value('lebref', (isset($mainChlorin['lebref'])) ? $mainChlorin['lebref'] : ''); ?>" />
											</div>
										</div>
									</div>
								</div>
								...
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row clearfix">
											...
											<div class="col-sm-9"><select name="projsystem" id="projsystem" class="form-control">
								...
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row clearfix">
											...
											<div class="col-sm-9"><input type="text" class="form-control" name="smppoint" value="<?php echo set_value('smppoint', (isset($mainChlorin['smppoint'])) ? $mainChlorin['smppoint'] : ''); ?>" /></div>
										</div>
									</div>
								...
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row clearfix">
											...
											<div class="col-sm-3"><input type="text" class="form-control num_0decimal" name="pilen1" value="<?php echo set_value('pilen1', (isset($mainChlorin['pilen1'])) ? $mainChlorin['pilen1'] : ''); ?>" /></div><div class="col-sm-1"> Metters</div><div class="col-sm-3"> <input type="text" class="form-control num_1decimal" name="pilen2" value="<?php echo set_value('pilen2', (isset($mainChlorin['pilen2'])) ? $mainChlorin['pilen2'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row clearfix">
											...
											<div class="col-sm-3"><input type="text" class="form-control num_0decimal" name="pidiameter1" value="<?php echo set_value('pidiameter1', (isset($mainChlorin['pidiameter1'])) ? $mainChlorin['pidiameter1'] : ''); ?>" /></div><div class="col-sm-1"> mm</div><div class="col-sm-3"> <input type="text" class="form-control num_1decimal" name="pidiameter2" value="<?php echo set_value('pidiameter2', (isset($mainChlorin['pidiameter2'])) ? $mainChlorin['pidiameter2'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">									
								...
								<div class="row form-group clearfix">									
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-7"><input type="text" class="form-control" name="disinfection_used" value="<?php echo set_value('disinfection_used', (isset($mainChlorin['disinfection_used'])) ? $mainChlorin['disinfection_used'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-3"><input type="text" class="form-control num_0decimal" name="levelsourcewater1" value="<?php echo set_value('levelsourcewater1', (isset($mainChlorin['levelsourcewater1'])) ? $mainChlorin['levelsourcewater1'] : ''); ?>" /></div>
											<div class="col-sm-1">MG/L</div>
											<div class="col-sm-3"><input type="text" class="form-control num_1decimal" name="levelsourcewater2" value="<?php echo set_value('levelsourcewater2', (isset($mainChlorin['levelsourcewater2'])) ? $mainChlorin['levelsourcewater2'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-3"><input type="text" class="form-control num_0decimal" name="levelafterdosing1" value="<?php echo set_value('levelafterdosing1', (isset($mainChlorin['levelafterdosing1'])) ? $mainChlorin['levelafterdosing1'] : ''); ?>" /></div>
											<div class="col-sm-1">MG/L</div>
											<div class="col-sm-3"><input type="text" class="form-control num_1decimal" name="levelafterdosing2" value="<?php echo set_value('levelafterdosing2', (isset($mainChlorin['levelafterdosing2'])) ? $mainChlorin['levelafterdosing2'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-3"><input type="text" class="form-control timepickerHH" name="contactime" value="<?php echo set_value('contactime', $contactime[0]); ?>" /></div>
											<div class="col-sm-1">Hours</div>
											<div class="col-sm-3"><input type="text" class="form-control timepickermm" name="contactime1" value="<?php echo set_value('contactime1', $contactime[1] ); ?>" /></div>
								...
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-3"><input type="text" class="form-control num_0decimal" name="levelaftercontact1" value="<?php echo set_value('levelaftercontact1', (isset($mainChlorin['levelaftercontact1'])) ? $mainChlorin['levelaftercontact1'] : ''); ?>" /></div>
											<div class="col-sm-1">MG/L</div>
											<div class="col-sm-3"><input type="text" class="form-control num_1decimal" name="levelaftercontact2" value="<?php echo set_value('levelaftercontact2', (isset($mainChlorin['levelaftercontact2'])) ? $mainChlorin['levelaftercontact2'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-3"><input type="text" class="form-control num_0decimal" name="resiafterflush1" value="<?php echo set_value('resiafterflush1', (isset($mainChlorin['resiafterflush1'])) ? $mainChlorin['resiafterflush1'] : ''); ?>" /></div>
											<div class="col-sm-1">MG/L</div>
											<div class="col-sm-3"><input type="text" class="form-control num_1decimal" name="resiafterflush2" value="<?php echo set_value('resiafterflush2', (isset($mainChlorin['resiafterflush2'])) ? $mainChlorin['resiafterflush2'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								...
								<div class="row form-group clearfix">									
									<div class="col-sm-12">
										...
										<div class="row">
											...
											<div class="col-sm-3"><input type="text" class="form-control timepickerHH" name="flushtimeclr" value="<?php echo set_value('flushtimeclr', $flushtimeclr[0]); ?>" /></div>
											<div class="col-sm-1">Hours</div>
											<div class="col-sm-3"><input type="text" class="form-control timepickermm" name="flushtimeclr1" value="<?php echo set_value('flushtimeclr1',$flushtimeclr[1]); ?>" /></div>
											<div class="col-sm-1">Minutes</div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-9"><input type="text" class="form-control" name="onsitetasterst" value="<?php echo set_value('onsitetasterst', (isset($mainChlorin['onsitetasterst'])) ? $mainChlorin['onsitetasterst'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<div class="row">
											...
											<div class="col-sm-9"><input type="text" class="form-control" name="onsiteodourrst" value="<?php echo set_value('onsiteodourrst', (isset($mainChlorin['onsiteodourrst'])) ? $mainChlorin['onsiteodourrst'] : ''); ?>" /></div>
										</div>
									</div>
								</div>
								<div class="row form-group clearfix">
								...
								<div class="row form-group clearfix">
									...
									<div class="col-sm-4"><input type="text" class="form-control num_0decimal" name="tvc3" value="<?php echo set_value('tvc3', (isset($mainChlorin['tvc3'])) ? $mainChlorin['tvc3'] : ''); ?>" /></div>
								</div>

								<div class="row form-group clearfix">
									<div class="col-sm-4"><strong>TVC 2 days @ 37&deg;</strong></div>
									<div class="col-sm-4"><strong>OFFICE TO COMPLETE</strong></div>
									<div class="col-sm-4"><input type="text" class="form-control num_0decimal" name="tvc2" value="<?php echo set_value('tvc2', (isset($mainChlorin['tvc2'])) ? $mainChlorin['tvc2'] : ''); ?>" /></div>
								</div>

								<div class="row form-group clearfix">
									<div class="col-sm-4"><strong>Coliforms/100ml</strong></div>
									<div class="col-sm-4"><strong>OFFICE TO COMPLETE</strong></div>
									<div class="col-sm-4"><input type="text" class="form-control num_0decimal" name="coliforms" value="<?php echo set_value('coliforms', (isset($mainChlorin['coliforms'])) ? $mainChlorin['coliforms'] : ''); ?>" /></div>
								</div>

								<div class="row form-group clearfix">
									<div class="col-sm-4"><strong>E.coli/100ml</strong></div>
									<div class="col-sm-4"><strong>OFFICE TO COMPLETE</strong></div>
									<div class="col-sm-4"><input type="text" class="form-control num_0decimal" name="ecoil" value="<?php echo set_value('ecoil', (isset($mainChlorin['ecoil'])) ? $mainChlorin['ecoil'] : ''); ?>" /></div>
								</div>
