					...
					<div class="clearfix">
						<div class="panel-body">
							...
							<div class="form-group clearfix">
								<table class="table table-bordered table-striped table-td-2" id="cwwaterdiststrcd">
									...
									<tbody>
										...
										<tr class="cwwaterdistxtrcdtr cwwaterdistxtrcd_tr_<?php echo $gd_key; ?>">
											...
											<td><input type="text" class="form-control num_1decimal deinfokvs" name="deinfokvs[]" value="<?php echo set_value('deinfokvs['.$gd_key.']', (isset($gd_value['deinfokvs'])) ? $gd_value['deinfokvs'] : ''); ?>" /></td>
											<td><input type="text" class="form-control deinforflowis num_3decimal" name="deinforflowis[]" value="<?php echo set_value('deinforflowis['.$gd_key.']', (isset($gd_value['deinforflowis'])) ? $gd_value['deinforflowis'] : ''); ?>" /></td>
											<td class="td_border_right"><input type="text" class="form-control num_2decimal deinfopdkpa" name="deinfopdkpa[]" readonly value="<?php echo set_value('deinfopdkpa['.$gd_key.']', (isset($gd_value['deinfopdkpa'])) ? $gd_value['deinfopdkpa'] : ''); ?>" /></td>
											...
											<td><input type="text" class="form-control measurregset" name="measurregset[]" value="<?php echo set_value('measurregset['.$gd_key.']', (isset($gd_value['measurregset'])) ? $gd_value['measurregset'] : ''); ?>" /></td>
											<td><input type="text" class="form-control measurbypasset" name="measurbypasset[]" value="<?php echo set_value('measurbypasset['.$gd_key.']', (isset($gd_value['measurbypasset'])) ? $gd_value['measurbypasset'] : ''); ?>" /></td>
								...
								<div class="text-right"><button type="button" class="btn btn-sm btn-primary design_measured_add">Add Row</button></div>
							</div>
