	...
	<section class="scrollable padder">
		...
		<header class="panel-heading">
				<div class="row clearfix">
					...
					<div class="col-sm-3">Process:&nbsp;&nbsp;&nbsp;<label class="radio-inline"><input type="radio" class="proshtstatus" value="1" name="optradio" <?php if(isset($sheetstatus)) { if(($sheetstatus)==1) { echo 'checked="checked"'; }  }  ?>>Enabled</label><label class="radio-inline"><input type="radio" class="proshtstatus" value="0" name="optradio" <?php if(isset($sheetstatus)) { if(($sheetstatus)==0) { echo 'checked="checked"'; }  } ?>>Disabled</label>
				...
				<div class="row form-group clearfix">
									...
									<div class="col-sm-4">
										<div class="row clearfix">
											...
											<div class="col-sm-8">
												<select name="projsystem" class="form-control">
															...
															if(intval($prcessid)!=0)
															{
												      		...
												      		?>
												      			<tr>
												      				...
												      				<label class="radio-inline"><input type="radio" name="commAirPreCommopt<?php echo $value1['id']; ?>" value="1" <?php echo $option1; ?> />Yes</label>
												      				<label class="radio-inline"><input type="radio" name="commAirPreCommopt<?php echo $value1['id']; ?>" value="2" <?php echo $option2; ?> />No</label>
												      				<label class="radio-inline"><input type="radio" name="commAirPreCommopt<?php echo $value1['id']; ?>" value="3" <?php echo $option3; ?> />N/A</label></td>
												      				<td width="34%"><input type="text" class="form-control" name="commAirPreCommcmd<?php echo $value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommcmd'.$value1['id'], (isset($commAirPreCommcmd)) ? $commAirPreCommcmd : ''); ?>" />
