				...
				<div class="row">
					...
					<div class="form-group clearfix">
						<div class="col-sm-4">
							...
							<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="commairwitness" placeholder="Enter Witness" value="<?php echo set_value('commairwitness', (isset($prcdata['u1fname'])) ? $prcdata['u1fname'].' '.$prcdata['u1lname'] : ''); ?>"  />
                			<?php echo form_error('commairwitness', '<div class="form-error">', '</div>'); ?>
                		</div>
						<div class="col-sm-4">
							<label><strong>Company:</strong><span class="mandatory"> *</span></label>
							<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="commaircmpy" placeholder="Enter Company" value="<?php echo set_value('commaircmpy', (isset($company_info['companyname'])) ? $company_info['companyname'] : ''); ?>"  />
                			<?php echo form_error('commaircmpy', '<div class="form-error">', '</div>'); ?>
                		</div>
                		<div class="col-sm-4">
							<label><strong>Date:</strong><span class="mandatory"> *</span></label>
							<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control datepicker" name="commairwitdate" value="<?php echo set_value('commairwitdate', (isset($prcdata['witnessdate'])) ? date('d m, Y',strtotime($prcdata['witnessdate'])) : date('d m, Y')); ?>" />
					...
					<div class="form-group clearfix">
						<div class="col-sm-4">
							...
							<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="commairtestcomp" placeholder="Enter Test Completed By" value="<?php echo set_value('commairtestcomp', (isset($prcdata['u2fname'])) ? $prcdata['u2fname'].' '.$prcdata['u2lname'] : ''); ?>"  />
						...
						<div class="col-sm-4">
							...
							<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="commairsercontract" placeholder="Enter Service Contractor" value="<?php echo set_value('commairsercontract', (isset($prcdata['servicecontractorname'])) ? $prcdata['servicecontractorname'] : ''); ?>"  />
                			<?php echo form_error('commairsercontract', '<div class="form-error">', '</div>'); ?>
                		</div>
                		<div class="col-sm-4">
							<label><strong>Date:</strong><span class="mandatory"> *</span></label>
							<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control datepicker" name="commairtestcompdate" value="<?php echo set_value('commairtestcompdate', (isset($prcdata['servicecontractdate'])) ? date('d m, Y',strtotime($prcdata['servicecontractdate'])) : date('d m, Y')); ?>" />
