					        ...
					        <div class="row form-group clearfix">
								...
								<div class="row form-group clearfix">
									<div class="col-sm-12">
										<table class="table table-bordered table-striped table-td-2" id="wtflushvelodata">
											...
											<tbody>
												...
												<tr class="wtflushvelo wtflushvelo_tr_<?php echo $gd_key; ?>">
													...
													<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control num_0decimal deinfokvs" name="deinfokvs[]" value="<?php echo set_value('deinfokvs['.$gd_key.']', (isset($gd_value['deinfokvs'])) ? $gd_value['deinfokvs'] : ''); ?>" /></td>
													...
													<td class="td_border_right"><input type="text" class="form-control deinfopdkpa" name="deinfopdkpa[]" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('deinfopdkpa['.$gd_key.']', (isset($gd_value['deinfopdkpa'])) ? $gd_value['deinfopdkpa'] : ''); ?>" /></td>
										...
										<div class="text-right"><button type="button" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'style="pointer-events: none"'; }  } ?> class="btn btn-sm btn-primary wtflushvelo_add">Add Row</button></div>
									</div>
								</div>
							<div class="row form-group clearfix">
								<div class="col-sm-12">
