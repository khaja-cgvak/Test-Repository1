								...
								<table class="table table-bordered table-striped table-td-5" id="dirgrillegrid">
									...
									<tbody>
										...
										<tr class="dirgrillegridtr dirgrillegridtr_<?php echo $gd_key; ?>">
											...
											<td><input type="text" name="correction_factor[]" class="form-control correction_factor dirgrillefield"  value="<?php echo set_value('correction_factor['.$gd_key.']', (isset($gd_value['correction_factor'])) ? $gd_value['correction_factor'] : ''); ?>" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly'; }  } ?>></td>
											<td><input type="text" name="actual_volume[]" class="form-control actual_volume dirgrillefield"  value="<?php echo set_value('actual_volume['.$gd_key.']', (isset($gd_value['actual_volume'])) ? $gd_value['actual_volume'] : ''); ?>" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly'; }  } ?>></td>
											<td><input type="text" name="record_percent[]" class="form-control record_percent dirgrillefield"  value="<?php echo set_value('record_percent['.$gd_key.']', (isset($gd_value['record_percent'])) ? $gd_value['record_percent'] : ''); ?>"<?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly'; }  } ?>></td>
								...
								<table class="table table-bordered table-striped" id="dirgrillemain">
									<tbody>
										...
										<tr>
											...
											<td><input type="text" name="grillehoodtotal" class="form-control grillehoodtotal" value="<?php echo set_value('grillehoodtotal', (isset($grillmain['grillehoodtotal'])) ? $grillmain['grillehoodtotal'] : ''); ?>" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly'; }  } ?>></td>
										</tr>
										<tr>
											<td>Direct Volume Reading Using Alnor Hood</td>
											<td><strong>Correction Factor:</strong></td>
											<td><input type="text" name="grillecorrfactor" class="form-control grillecorrfactor" value="<?php echo set_value('grillecorrfactor', (isset($grillmain['grillecorrfactor'])) ? $grillmain['grillecorrfactor'] : ''); ?>" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly'; }  } ?>>
