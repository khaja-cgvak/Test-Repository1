								...
								<table class="table table-bordered table-striped table-td-5" id="vlmctrlgrid">
									...
									<tbody>
										...
										<tr class="vlmctrlgridtr vlmctrlgridtr_<?php echo $gd_key; ?>">
											...
											<td class="td_border_right"><input type="text" name="min_percentage[]" class="form-control min_percentage vav_field" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('min_percentage['.$gd_key.']', (isset($gd_value['min_percentage'])) ? $gd_value['min_percentage'] : ''); ?>" ></td>
											...
											<td><input type="text" name="max_percentage[]" class="form-control max_percentage vav_field" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('max_percentage['.$gd_key.']', (isset($gd_value['max_percentage'])) ? $gd_value['max_percentage'] : ''); ?>" ></td>
