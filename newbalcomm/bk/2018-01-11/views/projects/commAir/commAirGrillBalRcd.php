		...
		<section class="panel panel-default">
			<header class="panel-heading">
				<div class="row clearfix">
					...
					<a href="<?php echo site_url('projects/'.$this->uri->segment(2).'/'.$this->uri->segment(3)); ?>" class="pull-left" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'style="pointer-events: none"'; }  } ?> 
       cursor: default;"><button type="button" class="btn btn-primary btn-xs" >Add New</button></a>
					<?php 
						$sheetnumber=1;
						...
						<div class="row form-group clearfix">
							<div class="col-sm-12">
								<table class="table table-bordered table-striped table-td-5" id="grillegrid">
									...
									<tbody>
										...
										<tr class="grillegridtr grillegridtr_<?php echo $gd_key; ?>">
											<td><input type="text" name="grilleno[]" class="form-control grilleno grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('grilleno['.$gd_key.']', (isset($gd_value['grilleno'])) ? $gd_value['grilleno'] : ''); ?>"></td>
											<td><input type="text" name="grille_hood_size[]" class="form-control grille_hood_size grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('grille_hood_size['.$gd_key.']', (isset($gd_value['grille_hood_size'])) ? $gd_value['grille_hood_size'] : ''); ?>"></td>
											<td><input type="text" name="area[]" class="form-control area grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('area['.$gd_key.']', (isset($gd_value['area'])) ? $gd_value['area'] : ''); ?>"></td>
											<td><input type="text" name="design_volume[]" class="form-control design_volume num_3decimal grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('design_volume['.$gd_key.']', (isset($gd_value['design_volume'])) ? $gd_value['design_volume'] : ''); ?>"></td>
											<td class="td_border_right"><input type="text" name="design_velocity[]" class="form-control design_velocity grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('design_velocity['.$gd_key.']', (isset($gd_value['design_velocity'])) ? $gd_value['design_velocity'] : ''); ?>" ></td>
											<td><input type="text" name="final_velocity[]" class="form-control final_velocity  num_2decimal grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('final_velocity['.$gd_key.']', (isset($gd_value['final_velocity'])) ? $gd_value['final_velocity'] : ''); ?>"></td>
											<td><input type="text" name="measured_volume[]" class="form-control measured_volume grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('measured_volume['.$gd_key.']', (isset($gd_value['measured_volume'])) ? $gd_value['measured_volume'] : ''); ?>" ></td>
											<td><input type="text" name="correction_factor[]" class="form-control correction_factor grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('correction_factor['.$gd_key.']', (isset($gd_value['correction_factor'])) ? $gd_value['correction_factor'] : ''); ?>" ></td>
											<td><input type="text" name="actual_volume[]" class="form-control actual_volume grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('actual_volume['.$gd_key.']', (isset($gd_value['actual_volume'])) ? $gd_value['actual_volume'] : ''); ?>" ></td>
											<td><input type="text" name="design[]" class="form-control design grillefield"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('design['.$gd_key.']', (isset($gd_value['design'])) ? $gd_value['design'] : ''); ?>" ></td>
								...
								<div class="text-right">
									<button type="button" class="btn btn-sm btn-primary grilleaddnew" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'style="pointer-events: none"'; }  } ?>>Add New</button>
								</div>
							</div>
						</div>
						<div class="row form-group clearfix">
								...
								<table class="table table-bordered table-striped" id="grillegridmain">
									<tbody>
										<tr>
											...
											<td><input type="text" name="grilleductotal" class="form-control num_3decimal grilleductotal"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('grilleductotal', (isset($grillmain['grilleductotal'])) ? $grillmain['grilleductotal'] : ''); ?>"></td>
										</tr>
										<tr>
											<td>Pitot traverse volume by the total of the grille indicated volume</td>
											<td><strong>Hood/Grille Total:</strong></td>
											<td><input type="text" name="grillehoodtotal" class="form-control grillehoodtotal"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('grillehoodtotal', (isset($grillmain['grillehoodtotal'])) ? $grillmain['grillehoodtotal'] : ''); ?>"></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td><strong>Correction Factor:</strong></td>
											<td><input type="text" name="grillecorrfactor" class="form-control grillecorrfactor"  <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> value="<?php echo set_value('grillecorrfactor', (isset($grillmain['grillecorrfactor'])) ? $grillmain['grillecorrfactor'] : ''); ?>" >
