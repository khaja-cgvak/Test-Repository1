													...
													if($value1['datatype']=='number')
													{
										      		...
										      		?>
										      			<tr>
										      				<td width="33%" class="text-left"><?php echo $value1['sectionname']; ?><span class="pull-right"><?php echo $value1['sectionuom']; ?></span><span class="clearfix"></span></td>
										      				<td width="33%" class="text-center">
										      				<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>  class="form-control <?php echo $numcheck; ?>" name="commAirPreCommopt<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommopt'.$procesSecCatid.'_'.$value1['id'], (isset($commAirPreCommopt)) ? $commAirPreCommopt : ''); ?>" />
										      				</td>
										      				<td width="34%"><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>  class="form-control" name="commAirPreCommcmd<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommcmd'.$procesSecCatid.'_'.$value1['id'], (isset($commAirPreCommcmd)) ? $commAirPreCommcmd : ''); ?>" />
										      					<input type="hidden" name="procesSection<?php echo $procesSecCatid; ?>[]" value="<?php echo $value1['id']; ?>" />
										      					<input type="hidden" name="procesSectionId<?php echo $value1['id']; ?>" value="<?php echo $procesSectionId; ?>" />
										      				</td>
										      			</tr>
													...
													if($value1['datatype']=='number')
													{
										      		...
										      		?>
										      			<tr class="pumpperformancelisttr">
										      				...
										      				<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control commAirPreCommopt <?php echo $numcheck; ?>" name="commAirPreCommopt<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommopt'.$procesSecCatid.'_'.$value1['id'], (isset($commAirPreCommopt)) ? $commAirPreCommopt : ''); ?>" />
										      				</td>
										      				<td width="22%">
										      					<?php if($key1==0) { ?>
										      						<div class="row clearfix"><div class="col-sm-6">
										      					<?php } ?>
										      					<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control commAirPreCommtestdata <?php if($key1==0) { echo $numcheck; } ?>" name="commAirPreCommtestdata<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommtestdata'.$procesSecCatid.'_'.$value1['id'], (isset($commAirPreCommtestdata)) ? $commAirPreCommtestdata : ''); ?>" />	
										      					<?php if($key1==0) { ?>
										      						</div>
										      						<div class="col-sm-6">
										      						<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>  class="form-control testdata_ans" name="testdata_ans<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('testdata_ans'.$procesSecCatid.'_'.$value1['id'], (isset($testdata_ans)) ? $testdata_ans : ''); ?>" />
										      						</div>
										      						</div>
										      					<?php } ?>
										      				</td>
										      				...
										      				<?php if($key1==0) { ?>
										      						<div class="row clearfix"><div class="col-sm-6">
										      					<?php } ?>
										      				<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control commAirPreCommtestdata1 <?php if($key1==0) { echo $numcheck; } ?>" name="commAirPreCommtestdata1<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommtestdata1'.$procesSecCatid.'_'.$value1['id'], (isset($commAirPreCommtestdata1)) ? $commAirPreCommtestdata1 : ''); ?>" />
										      				<?php if($key1==0) { ?>
										      						</div>
										      						<div class="col-sm-6">
										      						<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>  class="form-control testdata1_ans" name="testdata1_ans<?php echo $procesSecCatid.'_'.$value1['id']; ?>" placeholder="" value="<?php echo set_value('testdata1_ans'.$procesSecCatid.'_'.$value1['id'], (isset($testdata1_ans)) ? $testdata1_ans : ''); ?>" />
										      						</div>
										      						</div>
										      					<?php } ?>
										      					<input type="hidden" name="procesSection<?php echo $procesSecCatid; ?>[]" value="<?php echo $value1['id']; ?>" />
