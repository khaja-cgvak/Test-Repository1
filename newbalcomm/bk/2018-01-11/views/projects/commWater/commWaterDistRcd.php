					...
					<div class="clearfix">
						<div class="panel-body">
							...
							<div class="form-group clearfix">
								<table class="table table-bordered table-striped table-td-2" id="cwwaterdiststrcd">
									<thead>
										<tr>
									...
									<tbody>
										<tr>
											...
											<th class="text-center"><strong>Reg.<br>Set</strong></th>
											<th class="text-center"><strong>Bypass<br>set</strong></th>
										...
										<?php
											...
											{											
										?>
										<tr class="cwwaterdistxtrcdtr cwwaterdistxtrcd_tr_<?php echo $gd_key; ?>">
											...
											<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control num_0decimal deinfosizemm" name="deinfosizemm[]" value="<?php echo set_value('deinfosizemm['.$gd_key.']', (isset($gd_value['deinfosizemm'])) ? $gd_value['deinfosizemm'] : ''); ?>" /></td>
											...
											<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control deinforflowis num_3decimal" name="deinforflowis[]" value="<?php echo set_value('deinforflowis['.$gd_key.']', (isset($gd_value['deinforflowis'])) ? $gd_value['deinforflowis'] : ''); ?>" /></td>
											<td class="td_border_right"><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control num_2decimal deinfopdkpa" name="deinfopdkpa[]"  value="<?php echo set_value('deinfopdkpa['.$gd_key.']', (isset($gd_value['deinfopdkpa'])) ? $gd_value['deinfopdkpa'] : ''); ?>" /></td>
											...
											<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control measurflowis" name="measurflowis[]"  value="<?php echo set_value('measurflowis['.$gd_key.']', (isset($gd_value['measurflowis'])) ? $gd_value['measurflowis'] : ''); ?>" /></td>
											<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control measurpercen" name="measurpercen[]"  value="<?php echo set_value('measurpercen['.$gd_key.']', (isset($gd_value['measurpercen'])) ? $gd_value['measurpercen'] : ''); ?>" /></td>
											<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control measurregset" name="measurregset[]" value="<?php echo set_value('measurregset['.$gd_key.']', (isset($gd_value['measurregset'])) ? $gd_value['measurregset'] : ''); ?>" /></td>
											<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control measurbypasset" name="measurbypasset[]" value="<?php echo set_value('measurbypasset['.$gd_key.']', (isset($gd_value['measurbypasset'])) ? $gd_value['measurbypasset'] : ''); ?>" /></td>
											<td><div class="icon_list" style="width:auto;"><a href="#" data-toggle="tooltip" title="Remove Row" class="cwdesignmeasuredtrremove"><i class="fa fa-times" aria-hidden="true"></i></a></div><input type="hidden" name="cwdesignmeasured[]" class="cwdesignmeasured" value="<?php echo set_value('cwdesignmeasured['.$gd_key.']', (isset($gd_value['id'])) ? $gd_value['id'] : 0); ?>"> </td>
										</tr>
										<?php
										}
										?>
								...
								<div class="text-right"><button type="button" class="btn btn-sm btn-primary design_measured_add" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'style="pointer-events: none"'; }  } ?>>Add Row</button></div>
							</div>
...
<table class="table hidden">
	<tr class="cwdesignmeasuredclonwtr">
		...
		<td><input type="text" class="form-control measurregset" name="measurregset[]" value="" /></td>
		<td><input type="text" class="form-control measurbypasset" name="measurbypasset[]" value="" /></td>
		<td><div class="icon_list" style="width:auto;"><a href="#" data-toggle="tooltip" title="Remove Row" class="cwdesignmeasuredtrremove"><i class="fa fa-times" aria-hidden="true"></i></a></div><input type="hidden" name="cwdesignmeasured[]" class="cwdesignmeasured" value="0"></td>
	</tr>
</table>