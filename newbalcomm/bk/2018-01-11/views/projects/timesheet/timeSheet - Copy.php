							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control datepicker" name="daydate<?php echo $value['dayid']; ?>" value="<?php echo set_value('daydate'.$value['dayid'], (!empty($value['daydate']) && ($value['daydate']!='0000-00-00 00:00:00')) ? date(DT_FORMAT,strtotime($value['daydate'])) : ''); ?>" /></td>
										<td><input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control timepicker" name="dayhours<?php echo $value['dayid']; ?>" value="<?php echo set_value('dayhours'.$value['dayid'], (!empty($value['dayhours']) && ($value['dayhours']!='0000-00-00 00:00:00')) ? date(TIME_FORMAT,strtotime($value['dayhours'])) : ''); ?>" /></td>
										<td>
    ...
    <div id="checkboxes">
      ...
      <label for="three">
        <input type="checkbox" id="three" />Third checkbox</label>
											...
											<select class="form-control" multiple name="dayengg<?php echo $value['dayid']; ?>" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>>
											<!--<option value="">Please Select</option>-->
											<?php
