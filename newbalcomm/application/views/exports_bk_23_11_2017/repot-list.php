	...
	<section class="scrollable padder">
		<section class="panel panel-default">
			<header class="panel-heading">
				<div class="row clearfix"><div class="col-sm-6 col-xs-6 text-left"><b> <?php echo $title; ?> </b></div><div class="col-sm-6 col-xs-6 text-right"><a href="<?php echo site_url('reports/crereport/'.$proid); ?>"><i class="fa fa-plus-square-o" aria-hidden="true"></i>
