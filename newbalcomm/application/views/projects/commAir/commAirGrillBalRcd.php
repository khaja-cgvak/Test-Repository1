<section class="vbox">
	<section class="scrollable padder">
       ...
       style="cursor: default;"><button type="button" class="btn btn-primary btn-xs" >Add New</button></a>
					<?php 
						$sheetnumber=1;
								...
								<table class="table table-bordered table-striped table-td-5" id="grillegrid">
									...
									<tbody>
										...
										<tr class="grillegridtr grillegridtr_<?php echo $gd_key; ?>">
											...
											<td class="td_border_right"><input type="text" name="design_velocity[]" class="form-control design_velocity grillefield alwaysreadonly"  readonly value="<?php echo set_value('design_velocity['.$gd_key.']', (isset($gd_value['design_velocity'])) ? $gd_value['design_velocity'] : ''); ?>" ></td>
											...
											<td><input type="text" name="measured_volume[]" class="form-control measured_volume grillefield alwaysreadonly"  readonly value="<?php echo set_value('measured_volume['.$gd_key.']', (isset($gd_value['measured_volume'])) ? $gd_value['measured_volume'] : ''); ?>" ></td>
											<td><input type="text" name="correction_factor[]" class="form-control correction_factor grillefield alwaysreadonly"  readonly value="<?php echo set_value('correction_factor['.$gd_key.']', (isset($gd_value['correction_factor'])) ? $gd_value['correction_factor'] : ''); ?>" ></td>
											<td><input type="text" name="actual_volume[]" class="form-control actual_volume grillefield alwaysreadonly"  readonly value="<?php echo set_value('actual_volume['.$gd_key.']', (isset($gd_value['actual_volume'])) ? $gd_value['actual_volume'] : ''); ?>" ></td>
											<td><input type="text" name="design[]" class="form-control design grillefield alwaysreadonly"  readonly value="<?php echo set_value('design['.$gd_key.']', (isset($gd_value['design'])) ? $gd_value['design'] : ''); ?>" ></td>
								...
								<table class="table table-bordered table-striped" id="grillegridmain">
									<tbody>
										...
										<tr>
											...
											<td><input type="text" name="grillehoodtotal" class="form-control grillehoodtotal alwaysreadonly" readonly value="<?php echo set_value('grillehoodtotal', (isset($grillmain['grillehoodtotal'])) ? $grillmain['grillehoodtotal'] : ''); ?>"></td>
										</tr>
										<tr>
											<td>&nbsp;</td>
											<td><strong>Correction Factor:</strong></td>
											<td><input type="text" name="grillecorrfactor" class="form-control grillecorrfactor alwaysreadonly"  readonly value="<?php echo set_value('grillecorrfactor', (isset($grillmain['grillecorrfactor'])) ? $grillmain['grillecorrfactor'] : ''); ?>" >
...
<table class="table hidden">
	<tr class="grilleclonetr">
		...
		<td class="td_border_right"><input type="text" name="design_velocity[]" class="form-control design_velocity grillefield alwaysreadonly" value="" readonly></td>
