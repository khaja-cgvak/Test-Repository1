<section class="vbox">
	<section class="scrollable padder">
		<section class="panel panel-default">
			...
			<form method="POST" name="adduser" action="" class="addusernew commAirSysScheform processForm" enctype="multipart/form-data">
				<div class="row">
				<div class="col-sm-12">
				<div class="">
				<?php #echo '<pre>'; print_r($prcdata); echo '</pre>'; ?>
								...
								<div class="form-group clearfix">
									...
									<input type="file" name="uploadfile[]" id="imgInp" multiple <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>  onchange="getImgDetails()">
									<?php
									/*
								    <!--<div class="input-group col-xs-12">
								      <span class="input-group-addon"><i class="glyphicon glyphicon-picture"></i></span>
								      <input type="text" class="form-control input-lg"  placeholder="Upload File">
								      <span class="input-group-btn">
								        <button class="browse btn btn-primary input-lg" type="button"><i class="glyphicon glyphicon-search"></i> Browse</button>
								      </span>
								    </div>-->
								    <!-- <div class="image-details" id="image-details" style="<?php if(isset($prcdata['filestorename'])&&(!empty($prcdata['filestorename']))){  } else { echo 'display: none'; } ?>">
								    <?php
								    	
								    	{
								    		echo '<br><strong>File:</strong> <a href="';
								    		if(isset($prcdata['filestorename'])&&(!empty($prcdata['filestorename']))){
								    		base_url(UPATH.$prcdata['filestorename']);
								    		}
								    		echo '" target="_blank">';
								    		if(isset($prcdata['filestorename'])&&(!empty($prcdata['filestorename'])))
								    		{
								    		...
								    		echo '</a>';
								    		echo '<div class="form-group clearfix"><img id="img-upload" src="';
								    		if(isset($prcdata['filestorename'])&&(!empty($prcdata['filestorename']))){								    		
