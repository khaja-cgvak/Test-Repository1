	...
	<section class="scrollable padder">
		<section class="panel panel-default">
			...
			<div class="panel-body">
				<form method="POST" name="adduser" action="" id="adduser" enctype="multipart/form-data" class="addusernew processForm">
					<div class="row">
					<div class="col-sm-12">
					<div class="">
											...
											<td colspan="2" width="30%">
												<table class="table table-bordered table-td-2 margin-botton-0" id="plotrcdtable1">
													...
													<tr>
														...
														<td width="60%"><input type="text" name="duct_area_m2" class="form-control duct_area_m2 alwaysreadonly" readonly value="<?php echo set_value('duct_area_m2', (isset($prcdesign['duct_area_m2'])) ? $prcdesign['duct_area_m2'] : ''); ?>" ></td>
													</tr>
													<tr>
												...
												<table class="table table-bordered table-td-2 margin-botton-0" id="plotrcdtable1">
													<tbody>
														...
														<tr>
															...
															<td><input type="text" name="total_velocity" class="form-control total_velocity alwaysreadonly" readonly value="<?php echo set_value('total_velocity', (isset($prcdesign['total_velocity'])) ? $prcdesign['total_velocity'] : ''); ?>" ></td>
															<td><input type="text" name="average_velocity" class="form-control average_velocity alwaysreadonly" readonly value="<?php echo set_value('average_velocity', (isset($prcdesign['average_velocity'])) ? $prcdesign['average_velocity'] : ''); ?>" ></td>
															<td><input type="text" name="actual_volume" class="form-control actual_volume alwaysreadonly" readonly value="<?php echo set_value('actual_volume', (isset($prcdesign['actual_volume'])) ? $prcdesign['actual_volume'] : ''); ?>" ></td>
														</tr>
														<tr>
															
															<td colspan="2" class="text-center"><strong>Design %</strong></td>
															<td><input type="text" name="design" class="form-control plotrcddesign alwaysreadonly" readonly value="<?php echo set_value('design', (isset($prcdesign['design'])) ? $prcdesign['design'] : ''); ?>" ></td>
														</tr>
														<tr>
															<td colspan="2" class="text-center"><strong>No Test Points</strong></td>
															<td><input type="text" name="no_test_points" class="form-control no_test_points alwaysreadonly" readonly value="<?php echo set_value('no_test_points', (isset($prcdesign['no_test_points'])) ? $prcdesign['no_test_points'] : ''); ?>" ></td>
														</tr>
														<tr>
