                ...
                <?php echo form_error('userincharge', '<div class="form-error">', '</div>'); ?>
					...
					<div class="form-group clearfix">
						<div class="col-sm-4">
							...
							<input type="text" class="form-control" name="projectnumber" placeholder="Enter Project Number" value="<?php echo set_value('projectnumber', (isset($projdata['projectnumber'])) ? $projdata['projectnumber'] : ''); ?>" />
                <?php echo form_error('projectnumber', '<div class="form-error">', '</div>'); ?>
						</div>
						<div class="col-sm-4">
    	...
    	<form action="" method="post" class="frmaddsitemdl">
	      ...
	      <div class="modal-body">
	        <div class="form-group clearfix">
				<div class="col-sm-6">
					<label>Project Name<span class="mandatory"> *</span></label>
					<input class="form-control alphanumeric-format" type="text" name="sitename"  placeholder="Enter Project Name" value="<?php echo set_value('sitename', (isset($conde_value['sitename'])) ? $conde_value['sitename'] : ''); ?>" />
