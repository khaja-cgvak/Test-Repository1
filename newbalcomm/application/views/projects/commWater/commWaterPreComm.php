															...
															if(intval($prcessid)!=0)
															{
												      		...
												      		?>
												      			<tr>
												      				...
												      				<label class="radio-inline"><input type="radio" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'disabled="disabled"'; }  } ?> name="commAirPreCommopt<?php echo $value1['id']; ?>" value="1" <?php echo $option1; ?> />Yes</label>
												      				<label class="radio-inline"><input type="radio" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'disabled="disabled"'; }  } ?> name="commAirPreCommopt<?php echo $value1['id']; ?>" value="2" <?php echo $option2; ?> />No</label>
												      				<label class="radio-inline"><input type="radio" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'disabled="disabled"'; }  } ?> name="commAirPreCommopt<?php echo $value1['id']; ?>" value="3" <?php echo $option3; ?> />N/A</label></td>
												      				<td width="34%"><input type="text" class="form-control" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> name="commAirPreCommcmd<?php echo $value1['id']; ?>" placeholder="" value="<?php echo set_value('commAirPreCommcmd'.$value1['id'], (isset($commAirPreCommcmd)) ? $commAirPreCommcmd : ''); ?>" />
