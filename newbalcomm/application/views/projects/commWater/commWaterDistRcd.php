								...
								<table class="table table-bordered table-striped table-td-2" id="cwwaterdiststrcd">
									...
									<tbody>
										...
										<tr class="cwwaterdistxtrcdtr cwwaterdistxtrcd_tr_<?php echo $gd_key; ?>">
											...
											<td class="td_border_right"><input type="text" readonly class="form-control num_2decimal deinfopdkpa alwaysreadonly" name="deinfopdkpa[]"  value="<?php echo set_value('deinfopdkpa['.$gd_key.']', (isset($gd_value['deinfopdkpa'])) ? $gd_value['deinfopdkpa'] : ''); ?>" /></td>
