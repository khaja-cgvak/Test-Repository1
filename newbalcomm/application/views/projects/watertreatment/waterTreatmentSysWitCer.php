				...
				<div class="row">
					...
					<div class="form-group clearfix">
						...
						<div class="col-sm-4">
							...
							<input type="text"  class="form-control alwaysreadonly" readonly name="commaircmpy" placeholder="Enter Company" value="<?php echo set_value('commaircmpy', (isset($company_info['companyname'])) ? $company_info['companyname'] : ''); ?>"  />
