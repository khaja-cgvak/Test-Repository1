				...
				<div class="row">
					...
					<div class="form-group clearfix">
						<div class="col-sm-12">
							...
							<textarea style="height: 151px;" class="form-control" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> name="commairreptcomments" ><?php echo set_value('commairreptcomments', (isset($prcdata['reportdescription'])) ? $prcdata['reportdescription'] : ''); ?></textarea>
