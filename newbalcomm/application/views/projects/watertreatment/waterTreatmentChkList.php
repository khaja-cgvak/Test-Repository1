					...
					<div  class="">
											      		...
											      		<tr>
										      				...
										      				<td>
										      					<?php
										      						...
										      						{
										      							?>
										      						<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="mawatqph_<?php echo $value1['id']; ?>" value="<?php echo $curval; ?>" />
										      							<?php
										      						}
										      						else
										      						{
										      					?>
										      					<label class="radio-inline"><input type="radio" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'disabled="disabled"'; }  } ?> value="yes" name="mawatqph_<?php echo $value1['id']; ?>" <?php echo (($curval=='yes')?'checked="checked"':''); ?> >Yes</label>
																<label class="radio-inline"><input type="radio" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'disabled="disabled"'; }  } ?> value="no" name="mawatqph_<?php echo $value1['id']; ?>" <?php echo (($curval=='no')?'checked="checked"':''); ?> >No</label>
																<label class="radio-inline"><input type="radio" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'disabled="disabled"'; }  } ?> value="na" name="mawatqph_<?php echo $value1['id']; ?>" <?php echo (($curval=='na')?'checked="checked"':''); ?> >N/A</label>
																<?php
																	}
																?>
								...
								<div class="form-group clearfix">
									<div class="col-sm-4">
										...
										<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="chemical" placeholder="" value="<?php echo set_value('chemical', (isset($checkList['chemical'])) ? $checkList['chemical'] : ''); ?>" />
									</div>
									<div class="col-sm-4">
										<label>Inhibitor Dosage:</label>
										<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="inhibitor" placeholder="" value="<?php echo set_value('inhibitor', (isset($checkList['inhibitor'])) ? $checkList['inhibitor'] : ''); ?>" />
									</div>
									<div class="col-sm-4">
										<label>Biocide Dosage:</label>
										<input type="text" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?> class="form-control" name="biocide" placeholder="" value="<?php echo set_value('biocide', (isset($checkList['biocide'])) ? $checkList['biocide'] : ''); ?>" />
									</div>
								</div>
								<div class="form-group clearfix">
									<div class="col-sm-12">
									...
									<div class="col-sm-4">									
										...
										<select class="form-control" name="commairreptenggsign" <?php if(isset($sidemenu_sub_enable)) { if(($sidemenu_sub_enable)==0) { echo 'readonly="true"'; }  } ?>>
											...
											<?php
												...
												elseif(isset($_SESSION['watertreat_syscert_slected_engineer']))
												{
												$commairreptenggsign=$_SESSION['watertreat_syscert_slected_engineer'];
												}
												else
												{
