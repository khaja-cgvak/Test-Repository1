					...
					<div class="clearfix">
						<div class="panel-body">
								...
								<div class="form-group clearfix">
									<table class="table table-bordered table-striped" id="cwdesignmeasuredhws">
										...
										?>
											<tr class="cwwaterhwscd_tr_<?php echo $gd_key; ?>">
												<td><input type="text" class="form-control valveref" name="valveref[]" value="<?php echo set_value('valveref['.$gd_key.']', (isset($gd_value['valveref'])) ? $gd_value['valveref'] : ''); ?>" /></td>
												<td><input type="text" class="form-control num_1decimal valvetemp" name="valvetemp[]" value="<?php echo set_value('valvetemp['.$gd_key.']', (isset($gd_value['valvetemp'])) ? $gd_value['valvetemp'] : ''); ?>" /></td>
												<td>
												<?php 
													$checkboxck='';
												...
												<input type="checkbox" class="form-control failsafeopt" value="1" <?php echo $checkboxck; ?> />

												<input type="hidden" class="form-control failsafeopt1" name="failsafeopt[]" value="<?php echo intval($gd_value['failsafeopt']); ?>" />

												</td>
												<td><input type="text" class="form-control hwscmts" name="hwscmts[]" value="<?php echo set_value('hwscmts['.$gd_key.']', (isset($gd_value['hwscmts'])) ? $gd_value['hwscmts'] : ''); ?>" /></td>
									...
									<div class="text-right"><button type="button" class="btn btn-sm btn-primary cwdesignmeasuredhws_add">Add Row</button></div>
								</div>
