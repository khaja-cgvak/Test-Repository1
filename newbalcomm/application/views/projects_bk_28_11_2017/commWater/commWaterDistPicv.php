					...
					<div class="clearfix">
						<div class="panel-body">
							...
							<div class="form-group clearfix">
								<table class="table table-bordered table-striped table-td-2" id="cwwaterdiststpicv">
									...
									?>
										<tr class="cwwaterdistpicvrcdtr cwwaterdistpicvrcd_tr_<?php echo $gd_key; ?>">
											...
											<td><input type="text" class="form-control deinfopicvset" name="deinfopicvset[]" value="<?php echo set_value('deinfopicvset['.$gd_key.']', (isset($gd_value['deinfopicvset'])) ? $gd_value['deinfopicvset'] : ''); ?>" /></td>
											<td><input type="text" class="form-control deinfosizemm" name="deinfosizemm[]" value="<?php echo set_value('deinfosizemm['.$gd_key.']', (isset($gd_value['deinfosizemm'])) ? $gd_value['deinfosizemm'] : ''); ?>" /></td>
											...
											<td><input type="text" class="form-control measurflowis" readonly name="measurflowis[]" value="<?php echo set_value('measurflowis['.$gd_key.']', (isset($gd_value['measurflowis'])) ? $gd_value['measurflowis'] : ''); ?>" /></td>
											<td><input type="text" class="form-control measurpercen" readonly name="measurpercen[]" value="<?php echo set_value('measurpercen['.$gd_key.']', (isset($gd_value['measurpercen'])) ? $gd_value['measurpercen'] : ''); ?>" /></td>
								...
								<div class="text-right"><button type="button" class="btn btn-sm btn-primary design_measured_PICV_add">Add Row</button></div>
							</div>
