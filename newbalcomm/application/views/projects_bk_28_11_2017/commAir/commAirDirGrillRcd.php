								...
								<table class="table table-bordered table-striped table-td-5" id="dirgrillegrid">
									...
									<tbody>
										...
										<tr class="dirgrillegridtr dirgrillegridtr_<?php echo $gd_key; ?>">
											<td><input type="text" name="ref_no[]" class="form-control ref_no dirgrillefield" value="<?php echo set_value('ref_no['.$gd_key.']', (isset($gd_value['ref_no'])) ? $gd_value['ref_no'] : ''); ?>"></td>
											<td><input type="text" name="grille_size[]" class="form-control grille_size dirgrillefield" value="<?php echo set_value('grille_size['.$gd_key.']', (isset($gd_value['grille_size'])) ? $gd_value['grille_size'] : ''); ?>"></td>
											<td class="td_border_right"><input type="text" name="design_volume[]" class="form-control design_volume num_0decimal dirgrillefield" value="<?php echo set_value('design_volume['.$gd_key.']', (isset($gd_value['design_volume'])) ? $gd_value['design_volume'] : ''); ?>"></td>
											<td><input type="text" name="final_volume[]" class="form-control final_volume num_0decimal dirgrillefield" value="<?php echo set_value('final_volume['.$gd_key.']', (isset($gd_value['final_volume'])) ? $gd_value['final_volume'] : ''); ?>"></td>
											<td><input type="text" name="correction_factor[]" class="form-control correction_factor dirgrillefield" readonly value="<?php echo set_value('correction_factor['.$gd_key.']', (isset($gd_value['correction_factor'])) ? $gd_value['correction_factor'] : ''); ?>"></td>
											<td><input type="text" name="actual_volume[]" class="form-control actual_volume dirgrillefield" readonly value="<?php echo set_value('actual_volume['.$gd_key.']', (isset($gd_value['actual_volume'])) ? $gd_value['actual_volume'] : ''); ?>"></td>
											<td><input type="text" name="record_percent[]" class="form-control record_percent dirgrillefield" readonly value="<?php echo set_value('record_percent['.$gd_key.']', (isset($gd_value['record_percent'])) ? $gd_value['record_percent'] : ''); ?>"></td>
											<td><input type="text" name="setting[]" class="form-control setting dirgrillefield" value="<?php echo set_value('setting['.$gd_key.']', (isset($gd_value['setting'])) ? $gd_value['setting'] : ''); ?>"></td>
								...
								<table class="table table-bordered table-striped" id="dirgrillemain">
									<tbody>
										<tr>
											...
											<td><input type="text" name="grilleductotal" class="form-control num_1decimal grilleductotal" value="<?php echo set_value('grilleductotal', (isset($grillmain['grilleductotal'])) ? $grillmain['grilleductotal'] : ''); ?>"></td>
										</tr>
										<tr>
