											...
											<td colspan="2" width="30%">
												<table class="table table-bordered table-td-2 margin-botton-0" id="plotrcdtable1">
													<tr>
														...
														<td width="60%"><input type="text" name="traverseref" class="form-control traverseref" value="<?php echo set_value('traverseref', (isset($prcdesign['traverseref'])) ? $prcdesign['traverseref'] : ''); ?>"></td>
													</tr>
													<tr>
														<td class="text-center" width="40%"><strong>Traverse<br>Location</strong></td>
														<td width="60%"><input type="text" name="traverselocation" class="form-control traverselocation" value="<?php echo set_value('traverselocation', (isset($prcdesign['traverselocation'])) ? $prcdesign['traverselocation'] : ''); ?>"></td>
													</tr>
													<tr>
														...
														<td width="60%">
															<div class="row clearfix">
																<div class="col-sm-6">
																	<input type="text" name="duct_size_mm" class="form-control num_3decimal duct_size_mm" value="<?php echo set_value('duct_size_mm', (isset($prcdesign['duct_size_mm'])) ? $prcdesign['duct_size_mm'] : ''); ?>">
																</div>
																<div class="col-sm-6">
																	<input type="text" name="duct_size_mm1" class="form-control num_3decimal duct_size_mm1" value="<?php echo set_value('duct_size_mm1', (isset($prcdesign['duct_size_mm1'])) ? $prcdesign['duct_size_mm1'] : ''); ?>">
																</div>
															</div>
														</td>
													</tr>
													<tr>
														...
														<td width="60%"><input type="text" name="duct_area_m2" class="form-control duct_area_m2" value="<?php echo set_value('duct_area_m2', (isset($prcdesign['duct_area_m2'])) ? $prcdesign['duct_area_m2'] : ''); ?>" readonly></td>
													</tr>
													<tr>
														<td class="text-center" width="40%"><strong>Flow<br>Rate m&sup3;/s</strong></td>
														<td width="60%"><input type="text" name="flow_rate_m3_s" class="form-control num_3decimal flow_rate_m3_s" value="<?php echo set_value('flow_rate_m3_s', (isset($prcdesign['flow_rate_m3_s'])) ? $prcdesign['flow_rate_m3_s'] : ''); ?>"></td>
													</tr>
												</table>
											</td>											
											<td width="45%">
												<table class="table table-bordered table-td-2 margin-botton-0" id="plotrcdtable1">
													...
													?>
														<tr class="plotrcdgridtr plotrcdgridtr_<?php echo $gd_key; ?>">
															<td><input type="text" name="value1[]" value="<?php echo set_value('value1['.$gd_key.']', (isset($gd_value['volume1'])) ? $gd_value['volume1'] : ''); ?>" class="form-control num_1decimal volume1 volume"></td>
															<td><input type="text" name="value2[]" value="<?php echo set_value('value2['.$gd_key.']', (isset($gd_value['volume2'])) ? $gd_value['volume2'] : ''); ?>" class="form-control num_1decimal volume2 volume"></td>
															<td><input type="text" name="value3[]" value="<?php echo set_value('value3['.$gd_key.']', (isset($gd_value['volume3'])) ? $gd_value['volume3'] : ''); ?>" class="form-control num_1decimal volume3 volume"></td>
															<td><input type="text" name="value4[]" value="<?php echo set_value('value4['.$gd_key.']', (isset($gd_value['volume4'])) ? $gd_value['volume4'] : ''); ?>" class="form-control num_1decimal volume4 volume"></td>
															<td><input type="text" name="value5[]" value="<?php echo set_value('value5['.$gd_key.']', (isset($gd_value['volume5'])) ? $gd_value['volume5'] : ''); ?>" class="form-control num_1decimal volume5 volume"></td>
															<td><input type="text" name="value6[]" value="<?php echo set_value('value6['.$gd_key.']', (isset($gd_value['volume6'])) ? $gd_value['volume6'] : ''); ?>" class="form-control num_1decimal volume6 volume"></td>
															<td><input type="text" name="value7[]" value="<?php echo set_value('value7['.$gd_key.']', (isset($gd_value['volume7'])) ? $gd_value['volume7'] : ''); ?>" class="form-control num_1decimal volume7 volume"></td>
															<td><input type="text" name="value8[]" value="<?php echo set_value('value8['.$gd_key.']', (isset($gd_value['volume8'])) ? $gd_value['volume8'] : ''); ?>" class="form-control num_1decimal volume8 volume"></td>
															<td>
												...
												<div class="text-right"><button type="button" class="btn btn-xs btn-primary plotrcdaddnew">Add New</button></div>
											</td>
											<td width="25%">
												<table class="table table-bordered table-td-2 margin-botton-0" id="plotrcdtable1">
													<tbody>
														...
														<tr>
															...
															<td><input type="text" name="total_velocity" class="form-control total_velocity" value="<?php echo set_value('total_velocity', (isset($prcdesign['total_velocity'])) ? $prcdesign['total_velocity'] : ''); ?>" readonly></td>
															<td><input type="text" name="average_velocity" class="form-control average_velocity" value="<?php echo set_value('average_velocity', (isset($prcdesign['average_velocity'])) ? $prcdesign['average_velocity'] : ''); ?>" readonly></td>
															<td><input type="text" name="actual_volume" class="form-control actual_volume" value="<?php echo set_value('actual_volume', (isset($prcdesign['actual_volume'])) ? $prcdesign['actual_volume'] : ''); ?>" readonly></td>
														</tr>
														<tr>
															
															<td colspan="2" class="text-center"><strong>Design %</strong></td>
															<td><input type="text" name="design" class="form-control plotrcddesign" value="<?php echo set_value('design', (isset($prcdesign['design'])) ? $prcdesign['design'] : ''); ?>" readonly></td>
														</tr>
														<tr>
															<td colspan="2" class="text-center"><strong>No Test Points</strong></td>
															<td><input type="text" name="no_test_points" class="form-control no_test_points" value="<?php echo set_value('no_test_points', (isset($prcdesign['no_test_points'])) ? $prcdesign['no_test_points'] : ''); ?>" readonly></td>
														</tr>
														<tr>
															<td colspan="2" class="text-center"><strong>Static Pressure (Pa)</strong></td>
															<td>
															<input type="text" name="static_presssure" class="form-control num_1decimal" value="<?php echo set_value('static_presssure', (isset($prcdesign['static_presssure'])) ? $prcdesign['static_presssure'] : ''); ?>">
