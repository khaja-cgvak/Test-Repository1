						...
						<div class="row form-group clearfix">
							<div class="col-sm-12">
								<table class="table table-bordered table-striped table-td-5" id="vlmctrlgrid">
									...
									<tbody>
										...
										<tr class="vlmctrlgridtr vlmctrlgridtr_<?php echo $gd_key; ?>">
											<td><input type="text" name="vav_refno[]" class="form-control vav_refno vav_field" value="<?php echo set_value('vav_refno['.$gd_key.']', (isset($gd_value['vav_refno'])) ? $gd_value['vav_refno'] : ''); ?>"></td>
											<td><input type="text" name="vav_addr_ref[]" class="form-control vav_addr_ref vav_field" value="<?php echo set_value('vav_addr_ref['.$gd_key.']', (isset($gd_value['vav_addr_ref'])) ? $gd_value['vav_addr_ref'] : ''); ?>"></td>
											<td><input type="text" name="vav_nonimal_value[]" class="form-control vav_nonimal_value vav_field" value="<?php echo set_value('vav_nonimal_value['.$gd_key.']', (isset($gd_value['vav_nonimal_value'])) ? $gd_value['vav_nonimal_value'] : ''); ?>"></td>
											<td><input type="text" name="max_flow_m3_s[]" class="form-control max_flow_m3_s num_3decimal vav_field" value="<?php echo set_value('max_flow_m3_s['.$gd_key.']', (isset($gd_value['max_flow_m3_s'])) ? $gd_value['max_flow_m3_s'] : ''); ?>"></td>
											<td class="td_border_right"><input type="text" name="min_flow_m3_s[]" class="form-control min_flow_m3_s  num_3decimal vav_field" value="<?php echo set_value('min_flow_m3_s['.$gd_key.']', (isset($gd_value['min_flow_m3_s'])) ? $gd_value['min_flow_m3_s'] : ''); ?>"></td>
											<td><input type="text" name="min_p_pa[]" class="form-control min_p_pa  num_1decimal vav_field" value="<?php echo set_value('min_p_pa['.$gd_key.']', (isset($gd_value['min_p_pa'])) ? $gd_value['min_p_pa'] : ''); ?>"></td>
											<td><input type="text" name="min_volts[]" class="form-control min_volts  num_1decimal vav_field" value="<?php echo set_value('min_volts['.$gd_key.']', (isset($gd_value['min_volts'])) ? $gd_value['min_volts'] : ''); ?>"></td>
											<td><input type="text" name="min_vol_m3s[]" class="form-control min_vol_m3s num_3decimal vav_field" value="<?php echo set_value('min_vol_m3s['.$gd_key.']', (isset($gd_value['min_vol_m3s'])) ? $gd_value['min_vol_m3s'] : ''); ?>"></td>
											<td class="td_border_right"><input type="text" name="min_percentage[]" class="form-control min_percentage vav_field" value="<?php echo set_value('min_percentage['.$gd_key.']', (isset($gd_value['min_percentage'])) ? $gd_value['min_percentage'] : ''); ?>" readonly></td>
											<td><input type="text" name="max_p_pa[]" class="form-control max_p_pa  num_1decimal vav_field" value="<?php echo set_value('max_p_pa['.$gd_key.']', (isset($gd_value['max_p_pa'])) ? $gd_value['max_p_pa'] : ''); ?>"></td>
											<td><input type="text" name="max_volts[]" class="form-control max_volts  num_1decimal vav_field" value="<?php echo set_value('max_volts['.$gd_key.']', (isset($gd_value['max_volts'])) ? $gd_value['max_volts'] : ''); ?>"></td>
											<td><input type="text" name="max_vol_m3s[]" class="form-control max_vol_m3s num_1decimal vav_field" value="<?php echo set_value('max_vol_m3s['.$gd_key.']', (isset($gd_value['max_vol_m3s'])) ? $gd_value['max_vol_m3s'] : ''); ?>"></td>
											<td><input type="text" name="max_percentage[]" class="form-control max_percentage vav_field" value="<?php echo set_value('max_percentage['.$gd_key.']', (isset($gd_value['max_percentage'])) ? $gd_value['max_percentage'] : ''); ?>" readonly></td>
								...
								<div class="text-right">
									<button type="button" class="btn btn-sm btn-primary vlmctrladdnew">Add New</button>
								</div>
							</div>
						</div>
						<div class="row form-group clearfix">
