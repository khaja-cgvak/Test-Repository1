						...
						<div class="row form-group clearfix">
							<div class="col-sm-12">
								<table class="table table-bordered table-striped table-td-5" id="vlmctrlboxgrid">
									...
									<tbody>
										...
										<tr class="vlmctrlboxgridtr vlmctrlboxgridtr_<?php echo $gd_key; ?>">
											<td><input type="text" name="cav_refno[]" class="form-control cav_refno" value="<?php echo set_value('cav_refno['.$gd_key.']', (isset($gd_value['cav_refno'])) ? $gd_value['cav_refno'] : ''); ?>"></td>
											<td><input type="text" name="cav_addr_ref[]" class="form-control cav_addr_ref" value="<?php echo set_value('cav_addr_ref['.$gd_key.']', (isset($gd_value['cav_addr_ref'])) ? $gd_value['cav_addr_ref'] : ''); ?>"></td>
											<td><input type="text" name="cav_design_volume[]" class="form-control cav_design_volume num_3decimal" value="<?php echo set_value('cav_design_volume['.$gd_key.']', (isset($gd_value['cav_design_volume'])) ? $gd_value['cav_design_volume'] : ''); ?>"></td>
											<td><input type="text" name="max_flow_m3_s[]" class="form-control max_flow_m3_s num_3decimal" value="<?php echo set_value('max_flow_m3_s['.$gd_key.']', (isset($gd_value['max_flow_m3_s'])) ? $gd_value['max_flow_m3_s'] : ''); ?>"></td>
											<td class="td_border_right"><input type="text" name="max_p_pa_designed[]" class="form-control max_p_pa_designed  num_2decimal" value="<?php echo set_value('max_p_pa_designed['.$gd_key.']', (isset($gd_value['max_p_pa_designed'])) ? $gd_value['max_p_pa_designed'] : ''); ?>"></td>
											<td><input type="text" name="max_p_pa_measured[]" class="form-control max_p_pa_measured  num_2decimal" value="<?php echo set_value('max_p_pa_measured['.$gd_key.']', (isset($gd_value['max_p_pa_measured'])) ? $gd_value['max_p_pa_measured'] : ''); ?>"></td>
											<td><input type="text" name="max_volts[]" class="form-control max_volts  num_2decimal" value="<?php echo set_value('max_volts['.$gd_key.']', (isset($gd_value['max_volts'])) ? $gd_value['max_volts'] : ''); ?>"></td>
											<td><input type="text" name="max_vol_m3s[]" class="form-control max_vol_m3s num_3decimal" value="<?php echo set_value('max_vol_m3s['.$gd_key.']', (isset($gd_value['max_vol_m3s'])) ? $gd_value['max_vol_m3s'] : ''); ?>"></td>
											<td><input type="text" name="max_percentage[]" class="form-control max_percentage" value="<?php echo set_value('max_percentage['.$gd_key.']', (isset($gd_value['max_percentage'])) ? $gd_value['max_percentage'] : ''); ?>"></td>
								...
								<div class="text-right">
									<button type="button" class="btn btn-sm btn-primary vlmctrlboxaddnew">Add New</button>
								</div>
							</div>
						</div>
						<div class="row form-group clearfix">
